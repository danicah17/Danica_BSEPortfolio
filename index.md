...
Figure #2: Schematic of flex sensor, accelerometer, piezo buzzer with resistor
...
Figure #2: The commands I can type on my phone
...
Figure #3: The flow chart of my wrist turn code
...
Figure #4: The BLESerialnRF52 app and ESP32
...
Figure #5: Schematic for flex sensor, accelerometer, and piezo buzzer
...
Figure #7: Equations that I used
...
Figure #8: Roll, pitch, and yaw axes
...
Figure #9: Schematic for flex sensor and accelerometer

## Code

Figure #10: Code for first milestone
```c++
...
```
Figure #11: Code for second milestone
```c++
// Basic demo for accelerometer/gyro readings from Adafruit LSM6DS3TR-C
const int flexPin = A6;
const int fixedResistance = 10000;
...
```
Figure #12: Code for milestone 3
```c++
// Basic demo for accelerometer/gyro readings from Adafruit LSM6DS3TR-C
const int flexPin = A6;
const int fixedResistance = 10000;
