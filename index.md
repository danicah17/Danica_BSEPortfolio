...
### Piezo Buzzer
The piezo buzzer is an output device, so I tell it what to do in my code. I can control when it beeps, the frequency at which it beeps at, and how long it![milestone3schematic](https://github.com/user-attachments/assets/294bef4e-9b1f-4300-a040-26560ff51a0b)
 beeps for. Since I want the buzzer to beep for 3 different purposes, I set a different frequency each time so the user wouldn't be confused on what it's beeping about. For example, if the flex sensor bends past 30 degrees (the threshold I set), it will keep beeping at 1000 Hz until the flex sensor's angle is below 30. On the other hand, if I'm doing wrist turns, the piezo buzzer will beep at 3000 Hz for 500 milliseconds every time I complete a wrist turn.
...
Figure #1: The flow chart of my wrist turn code
...
Figure #2: The BLESerialnRF52 app and ESP32
...
Figure #3: Schematic for flex sensor, accelerometer, and piezo buzzer
...
Figure #5: Equations that I used
...
Figure #6: Roll, pitch, and yaw axes
...
Figure #7: Schematic for flex sensor and accelerometer
